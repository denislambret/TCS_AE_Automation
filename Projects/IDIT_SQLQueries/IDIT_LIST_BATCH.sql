...
DECLARE @STARTDATE DATETIME = '2023-08-11 00:00:00'; -- START DATE RANGE
DECLARE @ENDDATE DATETIME = '2023-08-11 23:59:59'; -- END DATE RANGE
DECLARE @JOB_NAME VARCHAR(120) = ''; -- NAME OF THE BATCH PROCESS AS DEFINED IN IDIT
