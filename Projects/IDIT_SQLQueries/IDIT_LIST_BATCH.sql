...
DECLARE @STARTDATE DATETIME = '2023-09-22 00:00:00'; -- START DATE RANGE
DECLARE @ENDDATE DATETIME = '2023-09-25 23:59:59'; -- END DATE RANGE
DECLARE @JOB_NAME VARCHAR(120) = 'GL Export - Monitoring'; -- NAME OF THE BATCH PROCESS AS DEFINED IN IDIT
