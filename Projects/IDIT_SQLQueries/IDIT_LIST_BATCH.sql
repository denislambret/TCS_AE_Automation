...
DECLARE @STARTDATE DATETIME = '2024-02-23 08:00:00'; -- START DATE RANGE
DECLARE @ENDDATE DATETIME = '2024-02-23 10:00:00'; -- END DATE RANGE
-- DECLARE @JOB_NAME VARCHAR(120) = '%'; 
-- DECLARE @JOB_NAME VARCHAR(120) = 'Client statement'; 
DECLARE @JOB_NAME VARCHAR(120) = 'Earned Premium Transactions'; 
-- DECLARE @JOB_NAME VARCHAR(120) = 'GL Export'; 
-- DECLARE @JOB_NAME VARCHAR(120) = 'Batch Processes Maintenance'; 
-- DECLARE @JOB_NAME VARCHAR(120) = 'Batch Process%'; 
-- DECLARE @JOB_NAME VARCHAR(120) = 'Performance Information Purge Job'; 
-- DECLARE @JOB_NAME VARCHAR(120) = 'Batch Statistics Gathering Job'; 
-- DECLARE @JOB_NAME VARCHAR(120) = 'Archiving master job'; 
-- DECLARE @JOB_NAME VARCHAR(120) = 'Logstash History Prune';
-- DECLARE @JOB_NAME VARCHAR(120) = 'ES Incremental Coordinator Job';
-- DECLARE @JOB_NAME VARCHAR(120) = 'Elastic Search Cache Remove';
-- DECLARE @JOB_NAME VARCHAR(120) = 'Combined Evaluation Release - Initiator';
-- DECLARE @JOB_NAME VARCHAR(120) = 'Send Portfolio Changes To NIP Initiator Job';
-- DECLARE @JOB_NAME VARCHAR(120) = 'Standard Renewal Coordinator Job plan';
-- DECLARE @JOB_NAME VARCHAR(120) = 'Daily Activities Coordinator Job plan';
-- DECLARE @JOB_NAME VARCHAR(120) = 'External Partner Upload Initiator Job';
-- DECLARE @JOB_NAME VARCHAR(120) = 'GL Export Coordinator Job plan';
