...
DECLARE @STARTDATE DATETIME = '2023-11-28 16:30:00'; -- START DATE RANGE
DECLARE @ENDDATE DATETIME = '2023-11-28 23:59:59'; -- END DATE RANGE
DECLARE @JOB_NAME VARCHAR(120) = '%Renewal%'; -- NAME OF THE BATCH PROCESS AS DEFINED IN IDIT
