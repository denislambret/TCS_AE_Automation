...
DECLARE @STARTDATE DATETIME = '2023-11-29 13:00:00'; -- START DATE RANGE
DECLARE @ENDDATE DATETIME = '2023-11-29 23:59:59'; -- END DATE RANGE
-- DECLARE @SERVER_ID VARCHAR(120) = '%ldc2as126%'; -- NAME OF THE BATCH1 PROCESS AS DEFINED IN IDIT
DECLARE @SERVER_ID VARCHAR(120) = '%ldc2as129%'; -- NAME OF THE BATCH2 PROCESS AS DEFINED IN IDIT
