...
from IDIT_ACP.dbo.T_BATCH_JOB
where SYSTEM_TRIGGER_CRON_EXPR is not null

-- Liste des schedules
select top 1000 *
from IDIT_ACP.dbo.QRTZ_CRON_TRIGGERS as cr

select top 1000 *
from IDIT_ACP.dbo.QRTZ_TRIGGERS
...
from IDIT_ACP.dbo.T_JOB_PLAN_STEP as jp 
inner join iDIT_ACP.dbo.T_BATCH_JOB as b
on b.id=jp.JOB_ID
