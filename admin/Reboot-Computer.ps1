...
<#
    .SYNOPSIS
        Restart a computer using current local session through powershell
...
PROCESS {
    ...
    Log -Level 'INFO' -message('Send reboot to server !' + $server)
    $result = Restart-Computer -force
